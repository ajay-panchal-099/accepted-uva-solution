//@ajay panchal
// problem name: uva 12289
// problem number from dt 20/04/20: 11
#include<bits/stdc++.h>
using namespace std;
...
int32_t main()
{
    ...
    TCase{
        ...
        if(str.length()>3)
            ...
            if(str[0]=='o' && str[1]=='n' && str[2]=='e') cout<<1<<endl;
            else if(str[0]=='o' && str[1]=='n') cout<<1<<endl;
            else if(str[0]== 'o' && str[2]=='e') cout<<1<<endl;
            else if(str[1]=='n' && str[2]=='e') cout<<1<<endl;
            else if(str[0]=='t' && str[1] =='w' && str[2]=='o') cout<<2<<endl;
            else if(str[0]=='t' && str[1]=='w') cout<<2<<endl;
            else if(str[0]=='t' && str[2]=='o') cout<<2<<endl;
            else if(str[1]=='w' && str[2]=='o') cout<<2<<endl;
        }
    };
